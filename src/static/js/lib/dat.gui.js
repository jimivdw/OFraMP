...
dat.dom.dom = (function (common) {
  ...
  var dom = {
     ...
     * @param elem
     */
    getOffset: function(elem, considerScroll) {
...
//    params.scrollable = common.isUndefined(params.parent) && params.scrollable === true;
    ...
    if (params.autoPlace) {
      ...
      // Make it not elastic.
      if (!this.parent) setWidth(_this, 0);
  ...
  common.extend(
      ...
      /** @lends dat.gui.GUI */
      {
        ...
        toggle: function() {
          ...
          var w = dom.getWidth(root.domElement);
          if(w > 10) {
            ...
            if(this.__reshow_width) {
              ...
              setWidth(root, GUI.DEFAULT_WIDTH);
            }
          }
        },
...
//      marginBottom: '6px',
    ...
    function setSV(e) {
      ...
      var o = dom.getOffset(_this.__saturation_field, true);
    ...
    function setH(e) {
      ...
      var o = dom.getOffset(_this.__hue_field, true);
...

      {
        ...
        updateDisplay: function() {
          ...
          linearGradient(
            this.__alpha_field,
            'top',
            'rgba(' + this.__color.r + ',' + this.__color.g + ',' + this.__color.b + ', 1)',
            'rgba(' + this.__color.r + ',' + this.__color.g + ',' + this.__color.b + ', .1)',
