var array = {
  ...
  /*
   * Return an array, consisting of only the elements in the given array arr for
   * which applying the function f to them returns true.
   * 
   * The parameter that will be provided to the function and can be used for
   * 'this' scoping.
   * 
   * If recursive is set to true, the filter will also be applied to the array's
   * subarrays.
   */
